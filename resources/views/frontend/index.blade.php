...
@section('content')
          ...
          <div class="row align-items-center justify-content-lg-start justify-content-center">
            <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-10 order-lg-1 order-1" data-aos="fade-up" data-aos-delay="700" data-aos-duration="1000">
              <div class="hero-l7-content">
                <h2>Media Pembelajaran Tali Temali</h2>
        ...
        <div class="row justify-content-lg-start justify-content-center align-items-center">
          ...
          <div class="offset-xl-1 col-xl-5 col-lg-6 col-md-10" data-aos="fade-up" data-aos-delay="700" data-aos-duration="1000">
            <div class="content-l5-2-content">
              ...
              <div class="btn-l5 btn-style-06">
                <a href="#jenis" class="d-flex align-items-center"><span></span>Pelajari Lebih Lanjut</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="contact-form-l3-area position-relative overflow-hidden bg-mirage" id="jenis">
